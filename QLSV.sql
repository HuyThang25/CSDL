...
SELECT TenSV as N'Tên sinh viên', TenMH as N'Tên môn học', Diem as N'Điểm'
FROM SINHVIEN	RIGHT JOIN KETQUA ON KETQUA.MaSV = SINHVIEN.MaSV
				RIGHT JOIN MONHOC ON MONHOC.MaMH = KETQUA.MaMH